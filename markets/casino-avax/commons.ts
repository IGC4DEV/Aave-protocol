...
export const CommonsConfig: ICommonConfiguration = {
  MarketId: 'AaveCasinoAvax',
  ATokenNamePrefix: 'Aave Avalanche Casino Market',
  StableDebtTokenNamePrefix: 'Aave Avalanche Casino Market stable debt',
  VariableDebtTokenNamePrefix: 'Aave Avalanche Casino Market variable debt',
  SymbolPrefix: 'v',
