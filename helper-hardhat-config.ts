...
export const NETWORKS_RPC_URL: iParamsPerNetwork<string> = {
  ...
  [ePolygonNetwork.mumbai]: 'https://polygon-mumbai.g.alchemy.com/v2/L6woZ6EkUZj8DrgK2YN6o6f1hFtyl7mr',//'https://rpc-mumbai.maticvigil.com',
...
export const NETWORKS_DEFAULT_GAS: iParamsPerNetwork<number> = {
  ...
  [eEthereumNetwork.goerli]: 5 * GWEI,
};
